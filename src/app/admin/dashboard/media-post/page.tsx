...
export default function MediaPostPage() {
  const [form, setForm] = useState<MediaPost>(initialForm);
  ...
  return (
    <article>
      ...
      <p className="mt-3 text-sm leading-7 tracking-tight text-slate-600 sm:text-base">
        Publish visual updates with image preview and full content summary.
      </p>
